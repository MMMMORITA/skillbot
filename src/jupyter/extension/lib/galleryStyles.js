...
exports.GALLERY_STYLES = `
:host {
  display: flex;
  flex-direction: column;
  height: 100%;
  min-width: 240px;
  background: ${panelStyles_1.CC.bg};
  color: ${panelStyles_1.CC.text};
...
.gallery-header {
  ...
  border-bottom: 1px solid ${panelStyles_1.CC.border};
  flex-shrink: 0;
}
.gallery-avatar {
  width: 22px;
  ...
  font-size: 13px;
  color: #08201f;
  background: linear-gradient(135deg, ${panelStyles_1.CC.accent}, ${panelStyles_1.CC.brand});
...
.gallery-tab:hover { color: ${panelStyles_1.CC.inactive}; }
.gallery-tab.active {
  color: ${panelStyles_1.CC.text};
  background: ${panelStyles_1.CC.surface};
  box-shadow: inset 0 -2px 0 ${panelStyles_1.CC.accent};
}
...
.gallery-card {
  background: ${panelStyles_1.CC.surface};
  border: 1px solid ${panelStyles_1.CC.border};
  border-radius: 10px;
  padding: 10px 12px;
  margin-bottom: 8px;
...
.gallery-card-desc {
  font-size: 11.5px;
  color: ${panelStyles_1.CC.inactive};
  line-height: 1.45;
}
.gallery-card-meta {
  margin-top: 6px;
...
.gallery-status {
  ...
  border-radius: 50%;
  flex-shrink: 0;
  background: ${panelStyles_1.CC.subtle};
}
.gallery-status.on {
  background: ${panelStyles_1.CC.success};
